...
export default class UserProfilePage extends React.Component {
    ...
    saveChanges(){
        return fetch('/users/updateProfile', {
            method: 'POST',
            body: JSON.stringify({userName: this.props.userName, userPassword: this.props.password, lastName: this.state.lastName, firstName: this.state.lastName, desiredSkills: this.state.desiredSkills, mySkills: this.state.mySkills}),
            credentials: 'include'
        })
